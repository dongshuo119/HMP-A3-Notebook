...
|---|---|
| Year | 2026 |
| Title | MvtText: A Multistage Latent Diffusion Framework for Text-Driven Human Motion Generation |
| BibTeX | [View BibTeX](#bibtex) |
| Conference | Not applicable (journal article) |
| Journal | IEEE Transactions on Multimedia |
| Benchmark | Not verified |
| Open Source | Not verified |
| Main Authors | Rizwan Abbas; Hua Gao; Xuewei Li; Xi Li |
| Paper Link | [Official paper](https://doi.org/10.1109/tmm.2026.3713759) |
...
```bibtex
@article{Abbas_2026, title={MvtText: A Multistage Latent Diffusion Framework for Text-Driven Human Motion Generation}, ISSN={1941-0077}, url={http://dx.doi.org/10.1109/tmm.2026.3713759}, DOI={10.1109/tmm.2026.3713759}, journal={IEEE Transactions on Multimedia}, publisher={Institute of Electrical and Electronics Engineers (IEEE)}, author={Abbas, Rizwan and Gao, Hua and Li, Xuewei and Li, Xi}, year={2026}, pages={1–12} }
```
...
Relevance: Core. The paper's central task is conditioned human motion generation, using not verified as part of the problem setting.
