...
> IEEE TPAMI 2026 · In-context Human Motion Prediction
>
...
|---|---|
| Year | 2026 |
| Title | Condition-Guided Diffusion for Multi-Modal Pedestrian Trajectory Prediction Incorporating Intention and Interaction Priors |
| BibTeX | [View BibTeX](#bibtex) |
| Conference | Not applicable (journal article) |
| Journal | IEEE Transactions on Pattern Analysis and Machine Intelligence |
| Benchmark | Not verified |
| Open Source | Not verified |
| Main Authors | Yanghong Liu; Xingping Dong; Yutian Lin; Mang Ye; Kaihao Zhang; Bo Du |
| Paper Link | [Official paper](https://doi.org/10.1109/tpami.2025.3645918) |
...
```bibtex
@article{Liu_2026, title={Condition-Guided Diffusion for Multi-Modal Pedestrian Trajectory Prediction Incorporating Intention and Interaction Priors}, volume={48}, ISSN={1939-3539}, url={http://dx.doi.org/10.1109/tpami.2025.3645918}, DOI={10.1109/tpami.2025.3645918}, number={4}, journal={IEEE Transactions on Pattern Analysis and Machine Intelligence}, publisher={Institute of Electrical and Electronics Engineers (IEEE)}, author={Liu, Yanghong and Dong, Xingping and Lin, Yutian and Ye, Mang and Zhang, Kaihao and Du, Bo}, year={2026}, month=Apr, pages={4406–4419} }
```
